...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler(PhysicianAvailabilityException.class)
	public ResponseEntity<?> allServiceNotFoundExceptions(PhysicianAvailabilityException ex, WebRequest request) {
